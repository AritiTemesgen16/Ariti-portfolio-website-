...
- **Full-Stack Project Case Studies**: Interactive deep dives into production systems (SmartSpend, EthiConnect, PharmaCore Ethiopia) complete with architecture diagrams, value metrics, and stack breakdowns.
...
| `APP_URL` | Application base URL for canonical tags & sitemap | `https://arititemesgen.com` |
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/AritiTemesgen16/Ariti-portfolio-website-.git
   cd Ariti-portfolio-website-
   ```
